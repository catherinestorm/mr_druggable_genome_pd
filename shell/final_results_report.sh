while read OUTCOME; do
    ...
    echo "exposure,outcome,nsnp,egger_intercept,egger_intercept_95_ci,egger_intercept_pvalue,cochrans_q,cochrans_q_pval,i2" > full_results/full_results_${OUTCOME}_qc.txt

    echo "exposure,outcome,nsnp,egger_intercept,egger_intercept_95_ci,egger_intercept_pvalue,cochrans_q,cochrans_q_pval,i2" > full_results/significant_results_${OUTCOME}_qc.txt
